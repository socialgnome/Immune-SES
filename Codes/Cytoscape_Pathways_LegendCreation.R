...
node$Class = "Upregulated genes"
node$Class[19:36] = "Downregulated genes"
node$Class[37:54] = "Upstream targets of\nupregulated genes"
node$Class[55:72] = "Upstream targets of\ndownregulated genes"
node$Class = factor(node$Class, levels = c("Upregulated genes","Downregulated genes","Upstream targets of\nupregulated genes","Upstream targets of\ndownregulated genes"))
...
p = ggplot(node, aes(x = Class, y = UNIQUE_ID, color = Class, fill = Class, size = FDR)) +
  ...
  theme(legend.text=element_text(size=16, family = "Calibri")) +
  theme(legend.title = element_markdown(size = 17, face = "bold", family = "Calibri")) +
